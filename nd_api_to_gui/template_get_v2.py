...
from nd_api_to_gui.ep_templates import EpTemplate
...
class TemplateGet:
    ...
    def _set_template_endpoint(self) -> None:
        ...
        if not self.template_name:
            ...
            msg += (
                "Set instance.template_name property before calling instance.refresh()"
            )
            self.log.error(msg)
    ...
    def refresh(self) -> None:
        ...
        self.template = {}
        self.template["template_name"] = self.response_current.get("DATA", {}).get(
            "name", ""
        )
