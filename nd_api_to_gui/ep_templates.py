...
class EpTemplate(Templates):
    ...
    -   `ValueError` if
        ...
        -   template_name is not a valid fabric template name.

    ## Path

    -   `/appcenter/cisco/ndfc/api/v1/configtemplates/rest/config/templates/{template_name}`
...
class EpTemplates(Templates):
    ...
    -   `/appcenter/cisco/ndfc/api/v1/configtemplates/rest/config/templates`
